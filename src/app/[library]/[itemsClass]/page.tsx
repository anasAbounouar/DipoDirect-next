    ...
    <section id="intern" className={`relative pb-4 bg-myContent  pt-7`}>
      ...
      >
        ...
        <h5 className="max-w-[1500px] mx-auto flex my-3 flex-col md:flex-row ">
          <p className="lg:text-left ml-6 flex-1 text-sm">
            Affichage de {startIndex}-{displayedItems?.length + startIndex} sur
            <strong className="mx-1">{finalFilter()?.length}</strong> resultats
          </p>

          {finalFilter().length >= itemsPerPage && <Pagination />}
        </h5>
